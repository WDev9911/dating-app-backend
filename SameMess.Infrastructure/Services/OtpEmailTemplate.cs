...
/// <summary>Dựng nội dung email OTP (subject + HTML) — dùng chung cho mọi cách gửi (SMTP, Resend...).</summary>
public static class OtpEmailTemplate
{
    public static (string Subject, string Html) Build(string otpCode, string purpose)
    {
